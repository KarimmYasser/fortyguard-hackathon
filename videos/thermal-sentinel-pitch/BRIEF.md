...
flow: automation
storyboard: yes
message: "Thermal Sentinel Grid: Physics-Constrained Agentic Thermal Resilience Engine for Grid Assets & Transformers"
destination: hackathon-submission
aspect: 1920x1080
language: en
length: 180s
angle: launch
style_preset: cyber-slate
---
...
- Dynamic animated number counters ($2.8M, P40 = 12.0h, +1.1°C, 5,835x ROI, $2,736,106 Net Avoided Loss).
...
- Adheres strictly to `PITCH_DECK.md` Part 1 script timings: Scene 1 (30s), Scene 2 (30s), Scene 3 (30s), Scene 4 (45s), Scene 5 (30s), Scene 6 (15s).
