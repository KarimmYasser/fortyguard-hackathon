...
* **[Value Proposition & AI Philosophy](research/VALUE_PROPOSITION_AND_AI_PHILOSOPHY.md):** Why physics-constrained Agentic AI outperforms black-box ML training, the 4-layer value matrix ($2.58M avoided loss, 5495x ROI), and keynote mentorship insights.
...
* **[Economic Model, UI Architecture & Video Pitch Script](research/ECONOMIC_MODEL_DASHBOARD_AND_PITCH_SCRIPT.md):** Investment-grade avoided loss formulation, customer interruption ($VoLL$), React/Vite operator dashboard wireframe, and second-by-second 3-minute video pitch script.
