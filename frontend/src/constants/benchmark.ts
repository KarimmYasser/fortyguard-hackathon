...
export const BENCHMARK = {
  ...
  baseline: {
    topOilC: 134.5,
    hotSpotC: 165.7,
    agingAccelerationX: 144.3,
    lossOfLifeHours: 609.2,
    failureProbabilityPct: 96.4,
  },
  ...
  mitigated: {
    topOilC: 84.8,
    hotSpotC: 112.2,
    agingAccelerationX: 1.25,
    lossOfLifeHours: 4.61,
  ...
  avoidedAgingHours: 604.6,
  netAvoidedLossUsd: 2736106,
  roiMultiple: 5834.9,
